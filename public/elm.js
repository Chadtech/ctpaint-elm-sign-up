...
Elm.ElmFire.make = function (_elm) {
   ...
   var LimitToLast = function (a) {    return {ctor: "LimitToLast",_0: a};};
   var limitToLast = LimitToLast;
   var LimitToFirst = function (a) {    return {ctor: "LimitToFirst",_0: a};};
   var limitToFirst = LimitToFirst;
   var NoLimit = {ctor: "NoLimit"};
   var noLimit = NoLimit;
   var EqualTo = function (a) {    return {ctor: "EqualTo",_0: a};};
   var equalTo = EqualTo;
   var Range = F2(function (a,b) {    return {ctor: "Range",_0: a,_1: b};});
   var range = Range;
   ...
   var noRange = NoRange;
   var OrderByPriority = F2(function (a,b) {    return {ctor: "OrderByPriority",_0: a,_1: b};});
   var orderByPriority = OrderByPriority;
   var OrderByKey = F2(function (a,b) {    return {ctor: "OrderByKey",_0: a,_1: b};});
   var orderByKey = OrderByKey;
   var OrderByValue = F2(function (a,b) {    return {ctor: "OrderByValue",_0: a,_1: b};});
   var orderByValue = OrderByValue;
   var OrderByChild = F3(function (a,b,c) {    return {ctor: "OrderByChild",_0: a,_1: b,_2: c};});
   var orderByChild = OrderByChild;
   var NoOrder = {ctor: "NoOrder"};
   var noOrder = NoOrder;
   var ChildMoved = function (a) {    return {ctor: "ChildMoved",_0: a};};
   var childMoved = ChildMoved;
   var ChildRemoved = function (a) {    return {ctor: "ChildRemoved",_0: a};};
   var childRemoved = ChildRemoved;
   var ChildChanged = function (a) {    return {ctor: "ChildChanged",_0: a};};
   var childChanged = ChildChanged;
   var ChildAdded = function (a) {    return {ctor: "ChildAdded",_0: a};};
   var childAdded = ChildAdded;
   var ValueChanged = function (a) {    return {ctor: "ValueChanged",_0: a};};
   ...
   var subscribe = function (createResponseTask) {    return subscribeConditional(function (_p0) {    return $Maybe.Just(createResponseTask(_p0));});};
   ...
   var Snapshot = F8(function (a,b,c,d,e,f,g,h) {    return {subscription: a,key: b,reference: c,existing: d,value: e,prevKey: f,priority: g,intern_: h};});
   var QueryError = F2(function (a,b) {    return {ctor: "QueryError",_0: a,_1: b};});
   var Unsubscribed = function (a) {    return {ctor: "Unsubscribed",_0: a};};
   var Subscription = {ctor: "Subscription"};
   var StringPriority = function (a) {    return {ctor: "StringPriority",_0: a};};
   var NumberPriority = function (a) {    return {ctor: "NumberPriority",_0: a};};
   var NoPriority = {ctor: "NoPriority"};
   var Reference = {ctor: "Reference"};
   var RefLocation = function (a) {    return {ctor: "RefLocation",_0: a};};
   var location = RefLocation;
   var PushLocation = function (a) {    return {ctor: "PushLocation",_0: a};};
   var push = PushLocation;
   var RootLocation = function (a) {    return {ctor: "RootLocation",_0: a};};
   var root = RootLocation;
   var ParentLocation = function (a) {    return {ctor: "ParentLocation",_0: a};};
   var parent = ParentLocation;
   var SubLocation = F2(function (a,b) {    return {ctor: "SubLocation",_0: a,_1: b};});
   var sub = SubLocation;
   var subscribeConnected = F2(function (createResponseTask,location) {
      return A4(subscribeConditional,
      function (snapshot) {
         var _p1 = A2($Json$Decode.decodeValue,$Json$Decode.bool,snapshot.value);
         if (_p1.ctor === "Ok") {
   ...
   var subscribeServerTimeOffset = F2(function (createResponseTask,location) {
      return A4(subscribeConditional,
      function (snapshot) {
         var _p2 = A2($Json$Decode.decodeValue,$Json$Decode.$float,snapshot.value);
         if (_p2.ctor === "Ok") {
   ...
   var UrlLocation = function (a) {    return {ctor: "UrlLocation",_0: a};};
   ...
   var AuthError = function (a) {    return {ctor: "AuthError",_0: a};};
   ...
   var Error = F2(function (a,b) {    return {tag: a,description: b};});
...
Elm.Types.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Model = F2(function (a,b) {    return {email: a,sent: b};});
   var Subscribe = {ctor: "Subscribe"};
   var RefreshField = function (a) {    return {ctor: "RefreshField",_0: a};};
   return _elm.Types.values = {_op: _op,RefreshField: RefreshField,Subscribe: Subscribe,Model: Model};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   _U.list([A2($Html.p,
           _U.list([$Html$Attributes.$class("point")
                   ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "44px"}
                                                   ,{ctor: "_Tuple2",_0: "margin",_1: "0px"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "inline"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "4em"}
                                                   ,{ctor: "_Tuple2",_0: "margin-right",_1: "22px"}]))]),
           _U.list([$Html.text("or")]))
           ,A2($Html.a,
           _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: "#030907"}
                                                   ,{ctor: "_Tuple2",_0: "border",_1: "none"}
                                                   ,{ctor: "_Tuple2",_0: "outline",_1: "none"}
                                                   ,{ctor: "_Tuple2",_0: "font-size",_1: "4em"}
                                                   ,{ctor: "_Tuple2",_0: "display",_1: "inline"}]))
                   ,$Html$Attributes.$class("point link")
                   ,$Html$Attributes.href("http://chadtech.github.io/ctpt/ctpaint.html#no-back-button")]),
           _U.list([$Html.text("go to CtPaint")]))]));
   var emailField = F2(function (content,address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "auto"},{ctor: "_Tuple2",_0: "width",_1: "60%"}]))]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.$class("field")
                      ,$Html$Attributes.placeholder("enter your email here")
                      ,$Html$Attributes.value(content)
                      ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (str) {    return A2($Signal.message,address,$Types.RefreshField(str));})]),
              _U.list([]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "background-color",_1: "#030907"}
                                                      ,{ctor: "_Tuple2",_0: "border",_1: "none"}
                                                      ,{ctor: "_Tuple2",_0: "outline",_1: "none"}]))
                      ,$Html$Attributes.$class("point link")
                      ,A2($Html$Events.onClick,address,$Types.Subscribe)]),
              _U.list([$Html.text("subscribe")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "auto"},{ctor: "_Tuple2",_0: "width",_1: "100%"}]))]),
              _U.list([A2($Html.p,
              _U.list([$Html$Attributes.$class("point ignorable")]),
              _U.list([$Html.text("I wont email you much, nor give your email away")]))]))
              ,goToApp]));
   });
   var $break = A2($Html.br,_U.list([]),_U.list([]));
   var headerImage = A2($Html.img,
   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "auto"},{ctor: "_Tuple2",_0: "display",_1: "block"}]))
           ,$Html$Attributes.src("ctpaint-logo.png")]),
   _U.list([]));
   var paragraphs = _U.list([A2($Html.p,
                            _U.list([$Html$Attributes.$class("point")]),
                            _U.list([$Html.text("CtPaint is a simple image editor that runs in your browser. Its simple. Its fast. Its the ideal for making pixel art, and drawing memes. Its also closely integrated with social media platforms like facebook and twitter. As easily as you can google search an image, you can open it up, edit it, and save it, in CtPaint.")]))
                            ,$break
                            ,A2($Html.p,
                            _U.list([$Html$Attributes.$class("point")]),
                            _U.list([$Html.text("An alpha version of CtPaint already exists for free. Id like to make it into something much greater than what it is today. Enter your email in the field above to stay in the loop.")]))]);
   return _elm.View.values = {_op: _op,paragraphs: paragraphs,headerImage: headerImage,$break: $break,goToApp: goToApp,emailField: emailField};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      var field = A2($View.emailField,model.email,address);
      var body = A2($List._op["::"],$View.headerImage,A2($List._op["::"],field,A2($List._op["::"],$View.$break,$View.paragraphs)));
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "auto"}
   ...
   var email = $Signal.mailbox("ye");
   var submission = function (m) {
      return $Basics.not(m.sent) ? $Effects.task(A2($Task.map,
      $Basics.always($Types.RefreshField("Thanks!")),
      A2($Signal.send,email.address,m.email))) : $Effects.none;
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "RefreshField") {
            return {ctor: "_Tuple2",_0: A2($Types.Model,_p0._0,model.sent),_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: A2($Types.Model,model.email,true),_1: submission(model)};
         }
   });
   var replace = F3(function (search,substitution,string) {
      return A4($Regex.replace,$Regex.All,$Regex.regex($Regex.escape(search)),function (_p1) {    return substitution;},string);
   });
   var urler = function (str) {    return A3(replace,".","+dot+",A3(replace,"@","+at+",str));};
   var url = "https://ctpaint-pre-order.firebaseio.com/emails/";
   var submit = Elm.Native.Task.make(_elm).performSignal("submit",
   function () {
      var setter = function (str) {    return $ElmFire.fromUrl(A2($Basics._op["++"],url,urler(str)));};
      return A2($Signal.map,function (str) {    return A2($ElmFire.set,$Json$Encode.string(str),setter(str));},email.signal);
   }());
   var init = {ctor: "_Tuple2",_0: A2($Types.Model,"",false),_1: $Effects.none};
